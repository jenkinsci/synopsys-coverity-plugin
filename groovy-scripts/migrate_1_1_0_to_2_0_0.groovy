...
if (oldGlobalConfigXmlPath && oldGlobalConfigXmlPath.exists()) {
    ...
    try {
        ...
        if (coverityGlobalConfig.getCoverityConnectInstances() == null) {
            List<com.synopsys.integration.jenkins.coverity.extensions.global.CoverityConnectInstance> coverityConnectInstances = new ArrayList<>();
            coverityGlobalConfig.setCoverityConnectInstances(coverityConnectInstances);
        }
    ...
    if (item instanceof FreeStyleProject) {
        ...
        if (oldCoverityConfig) {
            ...
            try {
                ...
                newCoverityConfig = new com.synopsys.integration.jenkins.coverity.extensions.buildstep.CoverityBuildStep(coverityInstanceUrl,
                        onCommandFailure,
                        projectName,
                        streamName,
