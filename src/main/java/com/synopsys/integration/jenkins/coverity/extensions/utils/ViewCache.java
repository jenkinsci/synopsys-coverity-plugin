...
public class ViewCache extends CoverityConnectDataCache<List<String>> {
    ...
    @Override
    protected List<String> getFreshData(final CoverityConnectInstance coverityConnectInstance) {
        List<String> data = Collections.emptyList();

        try {
            final Map<Long, String> viewMap = UiWebServices.withLogger(logger).getAllViews(coverityConnectInstance);
