...
public class RunCoverityCommands {
    ...
    public RunCoverityCommands(final JenkinsCoverityLogger logger, final IntEnvironmentVariables intEnvironmentVariables, final String remoteWorkingDirectory, final List<List<String>> commands, final OnCommandFailure onCommandFailure,
    ...
    public void runCoverityCommands() throws IntegrationException, InterruptedException, IOException {
