...
function loadProjects() {
    ...
    var fillURL = jenkinsRootUrl + "/descriptor/com.synopsys.integration.jenkins.coverity.buildstep.freestyle.CoverityBuildStep/fillProjectNameItems";
...
function loadStreams() {
    ...
    var fillURL = jenkinsRootUrl + "/descriptor/com.synopsys.integration.jenkins.coverity.buildstep.freestyle.CoverityBuildStep/fillStreamNameItems";
...
function loadViews() {
    ...
    var fillURL = jenkinsRootUrl + "/descriptor/com.synopsys.integration.jenkins.coverity.buildstep.CheckForIssuesInView/fillViewNameItems";
